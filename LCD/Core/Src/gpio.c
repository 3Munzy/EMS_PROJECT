...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, LED_GREEN_Pin|ST7789_DC_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : BTN_CALIBRATE_Pin */
  GPIO_InitStruct.Pin = BTN_CALIBRATE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(BTN_CALIBRATE_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : LED_GREEN_Pin ST7789_DC_Pin */
  GPIO_InitStruct.Pin = LED_GREEN_Pin|ST7789_DC_Pin;
